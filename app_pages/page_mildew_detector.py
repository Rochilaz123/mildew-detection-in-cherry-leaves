...
def page_mildew_detector_body():
    ...
    st.success(
            f"Upload pictures of cherry leaves here to assess if the leaves "
            f" are healthy or infected with powdery mildew."
            f" You will be able to download a report of the results."
            )
    ...
    images_buffer = st.file_uploader(
        'Upload images of leaves here. You may select more than one.',
    ...
    st.info(
        f"This page fulfills Business Requirement 2:\n\n"
